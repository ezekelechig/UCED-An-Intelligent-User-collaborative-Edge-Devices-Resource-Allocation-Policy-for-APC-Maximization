#Actor Critic project in python
...
class ActorMainNetwork():
    

    def __init__(self, cecc, s_dimen, action_dim, action_bound, learning_rate, tau, batch_size, user_id=''):
        self.cecc = cecc
        self.s_dimen = s_dimen
        ...
        # Code combines the gradients here
        grads = tf.gradients(
            self.scaled_out, self.network_params, self.action_gradient)
        # the gradient should not be None
